 ...
 * Modified by solon to support binary data in as input
 * @author Solon Li 
 */
public final class QRCodeWriter implements Writer {
  ...
  public BitMatrix encode(String contents,
    ...
    QRCode code = (hints !=null && hints.containsKey(EncodeHintType.QR_LargerAlign))? 
    		EncoderLargerAlign.encode(contents, errorCorrectionLevel, hints)
 ...
 public BitMatrix encode(byte[] array,
	...
	QRCode code = (hints !=null && hints.containsKey(EncodeHintType.QR_LargerAlign))? 
    		EncoderLargerAlign.encode(array, fileType, errorCorrectionLevel, hints)
    		: Encoder.encode(array, fileType, errorCorrectionLevel, hints);	
