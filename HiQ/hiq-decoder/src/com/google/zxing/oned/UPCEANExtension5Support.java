...
final class UPCEANExtension5Support {
  ...
  Result decodeRow(int rowNumber, BitArray row, int[] extensionStartRange) throws NotFoundException {
    ...
    Map<ResultMetadataType,String> extensionData = parseExtensionString(resultString);
    ...
    if (extensionData != null) {
      //extensionResult.putAllMetadata(extensionData);
    	extensionResult.putAllStringMetadata(extensionData);
    }
   ...
   */
  private static Map<ResultMetadataType,String> parseExtensionString(String raw) {
    if (raw.length() != 5) {
      return null;
    }
    ...
    Map<ResultMetadataType,String> result 
