 ...
 * @author Sean Owen
 * 
 * Modified by Solon on late March 2013 
 * Create selectBestPatternsNew()  and NearestFromAverageComparator() to better select center of finder pattern
 * Accept one more hints: minimum module size, so that detector can filter out obvious error points
 * on late April 2013
 * change the variables to protected so that its subclass can access the variables here
 * Also to the some private classes and methods inside this class
 */
public class FinderPatternFinder {

  private static final int CENTER_QUORUM = 2;
  protected static final int MIN_SKIP = 3; // 1 pixel/module times 3 modules/center
  protected static final int MAX_MODULES = 177; // support up to version 10 for mobile clients, should be 57
  private static final int INTEGER_MATH_SHIFT = 8;

  protected final BitMatrix image;
  protected final List<FinderPattern> possibleCenters;
  ...
  FinderPatternInfo find(Map<DecodeHintType,?> hints) throws NotFoundException {
    ...
    int minModuleSize = (hints != null && hints.containsKey(DecodeHintType.MINIMUM_MODULE_SIZE))? (Integer) hints.get(DecodeHintType.MINIMUM_MODULE_SIZE):0;
  ...
  protected static boolean foundPatternCross(int[] stateCount) {
    ...
    int maxVariance = (int) (moduleSize * 0.7f);
   ...
   */
  protected float crossCheckVertical(int startI, int centerJ, int maxCount, 
   ...
   */
  protected float crossCheckHorizontal(int startJ, int centerI, int maxCount,
      int originalStateCountTotal) {
    BitMatrix image = this.image;
   ...
   */
  protected FinderPattern[] selectBestPatterns() throws NotFoundException {
   ...
   */
  protected static class FurthestFromAverageComparator implements Comparator<FinderPattern>, Serializable {
    private final float average;
    protected FurthestFromAverageComparator(float f) {
      average = f;
    }
    @Override
