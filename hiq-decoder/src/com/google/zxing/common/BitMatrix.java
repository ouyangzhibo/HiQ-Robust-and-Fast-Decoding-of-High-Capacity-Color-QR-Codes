 ...
 * 
 * @author Solon Li return dummy value when the get(x,y) is out of the bitmatrix boundary 
 */
public final class BitMatrix implements Cloneable {
  ...
  public boolean get(int x, int y) {
    ...
    if(offset>bitsLength) return false;
