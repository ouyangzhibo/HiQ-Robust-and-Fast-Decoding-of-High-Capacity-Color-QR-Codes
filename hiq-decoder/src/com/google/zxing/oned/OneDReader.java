  ...
  public Result decode(BinaryBitmap image,
    ...
    try {
      ...
      if (tryHarder && image.isRotateSupported()) {
        ...
        int orientationInMetaData=result.getIntMetadata(ResultMetadataType.ORIENTATION);
        int orientation = 270;
        if(orientationInMetaData >0){
          // But if we found it reversed in doDecode(), add in that result here:
          orientation = (orientation + orientationInMetaData) % 360;
        }
