...
final class UPCEANExtension2Support {
  ...
  Result decodeRow(int rowNumber, BitArray row, int[] extensionStartRange) throws NotFoundException {
    ...
    Map<ResultMetadataType,Integer> extensionData = parseExtensionString(resultString);
    ...
    if (extensionData != null) {
      //extensionResult.putAllMetadata(extensionData);
    	extensionResult.putAllIntMetadata(extensionData);
    }
   ...
   */
  private static Map<ResultMetadataType,Integer> parseExtensionString(String raw) {
    if (raw.length() != 2) {
      return null;
    }
    Map<ResultMetadataType,Integer> result 
