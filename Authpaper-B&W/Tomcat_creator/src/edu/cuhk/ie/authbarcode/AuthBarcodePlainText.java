...
//Encoding side
	...
	public void compressAndSignData() throws Exception {
		...
		*/
		...
		String messageToSign=middleWarningMessage[middleWarningMessage.length-1]+messageDivider
		...
		signedMessage=middleWarningMessage[middleWarningMessage.length-1]+messageDivider
					+unsignedMsg.replace(messageDivider, "#"+messageDivider)+messageDivider
					+JSONtoStringSorted(signatureObject);
